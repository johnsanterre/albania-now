...
T["ds-1"] = ("When you press play in Colab, your code "
 ...
 "punishment. It is a report: what stopped the code, on which line, often with a "
 "guess at the fix. People who read the report go fast; people who fear it go "
 "slow. One more thing to watch for: Python treats seven-in-quotes as text and "
 "seven-without-quotes as a number. Half of all beginner errors are those two "
