...
<div class="progresswrap">
  ...
  <div class="plabel"><span id="pdone">0</span> of 8 segments complete</div>
</div>
...
<section class="seg" data-seg="deeper">
  <div class="stype">5 · Go deeper <span style="color:var(--ink2);letter-spacing:0;text-transform:none;font-weight:400">— optional, for when the lesson wasn't enough</span></div>
  <h2>@@DEEPER_H2@@</h2>
@@DEEPER_HTML@@
...
<section class="seg" data-seg="check">
  <div class="stype">6 · Quick check</div>
  <h2>Check yourself</h2>
@@QUIZ_HTML@@
</section>

<section class="seg" data-seg="build">
  <div class="stype">7 · Build</div>
  <h2>@@BUILD_H2@@</h2>
  <div class="buildtask">
...
(function(){
  ...
  const SEGS=['watch','listen','read','code','deeper','check','build','done'];
  let state={};
...
''',
 ...
 build_h2='Make the computer do something 500 times',
 build_html='''
  <p>In the notebook, make a new cell that prints a sentence about your town 500
  times. You have not been taught how — that is on purpose. Ask an AI assistant or
  search for it, run what you get, and make sure you understand every word of the
  code before you keep it. Then change it to print the numbers 1 to 500 instead.</p>
  <p><b>Turn-in:</b> a screenshot of your cell and part of its output, to your
  teacher.</p>
''',
 fig_js='''
(function(){
