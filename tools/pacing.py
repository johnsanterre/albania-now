...
TARGET = (120, 240)   # minutes; the 2-4h promise
...
def main():
    out = ['# Albania Now — pacing map (measured)', '',
           ...
           'Target per lesson: **%d–%d min**. Rates are stated in the script and '
           'lean fast; calibrate against a real pilot student.' % TARGET, '']
    grand = []
